...
namespace LazyCrudGenerator\Console\Commands;

use Illuminate\Console\Command;
use DB;
use Artisan;
use LazyCrudGenerator\LazyCrudGeneratorService;

class LazyCrudGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:lazycrud {model-name} {--force} {--singular} {--table-name=} {--master-layout=} {--custom-controller=}';
    ...
    public function handle()
    {
        ...
        {
            $generator = new LazyCrudGeneratorService();
